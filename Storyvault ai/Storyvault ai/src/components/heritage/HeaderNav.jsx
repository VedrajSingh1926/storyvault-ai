...
import { BookMarked, ChefHat, Landmark, Map, PenSquare } from "lucide-react";
...
const TABS = [
  ...
  },
  {
    ...
    icon: ChefHat,
    emoji: "🍲",
    guide: "Rediscover forgotten dishes with structured cultural context, ingredients, and preparation.",
  },
  {
    id: "travel",
    label: "NRI Travel Planner",
    icon: Map,
    emoji: "✈️",
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="logo-spin-dual flex h-11 w-11 items-center justify-center rounded-2xl border border-[#E6C697]/25 bg-gradient-to-br from-[#201810] to-[#0d0d0c] shadow-[0_0_18px_rgba(230,198,151,0.14)]"
              aria-label="Go to StoryVault AI home"
            >
              <span className="font-heading text-base text-[#E6C697]">SV</span>
            </button>
          ...
          <nav className="flex items-center gap-1 overflow-x-auto scrollbar-hide">
            {TABS.map((tab) => {
              ...
              return (
                <div key={tab.id} className="relative" onMouseEnter={() => setHoveredTab(tab.id)} onMouseLeave={() => setHoveredTab(null)}>
                  <button
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div layoutId="activeTabUnderline" className="absolute bottom-0 left-2 right-2 h-[2px] bg-[#E6C697] rounded-full" />
                    )}
                  </button>
